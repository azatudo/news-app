...
> ⚠️ В Expo Go существуют ограничения, для полноценной поддержки remote push требуется development build.
...
Все обязательные пункты тестового задания реализованы.  
